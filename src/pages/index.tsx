...
export default function Home() {
  return (
    <Layout>
      ...
      >
        <div className="prose container flex py-8 mx-auto">
          <div className="bg-white border border-gray-500 rounded w-11/12 sm:w-7/12 mx-auto px-2 py-2 shadow">
            ...
            <p>
              When I'm not working, I'm usually hanging out with my wife and two
              young kids. When they're asleep, I might be playing Overwatch on
              the Xbox. 😃
            </p>
          </div>
        </div>
